...
export const ARCHIVE_TEXT = {
  ko: {
    ...
    searchPlaceholder: "제목, 키워드, 날짜로 검색", categoryHint: "← 좌우로 밀어서 카테고리를 확인하세요 →",
    ...
    guideTitle: "아카이브 이용 가이드", guideSearchLabel: "검색", guideCalendarLabel: "캘린더", guideFilterLabel: "필터",
    guideSearch: "날짜(2024-01-01), 초성, 키워드로 검색이 가능합니다.",
    guideCalendar: "점이 표시된 날짜를 클릭하면 해당 날짜의 기록을 모아볼 수 있습니다.",
    guideFilter: "카테고리와 상세 분류를 통해 원하는 영상을 빠르게 찾아보세요. 상단 카테고리 메뉴는 옆으로 스크롤할 수 있습니다.",
    guideContact: "오류 및 기타 문의사항은 @Penta_1031로 문의해 주세요.",
    todayTitle: "{month}월 {day}일의 기록", yearsAgo: "{years}년 전 오늘"
  },
  zh: {
    archive: "存档", keywords: "关键词", today: "往年今日",
    searchPlaceholder: "搜索标题、关键词或日期", categoryHint: "← 左右滑动查看分类 →",
    ...
    guideTitle: "存档使用指南", guideSearchLabel: "搜索", guideCalendarLabel: "日历", guideFilterLabel: "筛选",
    guideSearch: "您可以通过日期(2024-01-01)、首字母或关键词进行搜索。（请用韩语搜索）",
    guideCalendar: "点击带点的日期即可查看当天的记录。",
    guideFilter: "通过类别和详细筛选快速找到您想要的视频。顶部分类菜单可以横向滑动。",
    guideContact: "错误及其他咨询请联系 @Penta_1031。",
    todayTitle: "{month}月{day}日的记录", yearsAgo: "{years}年前的今天"
  },
  ja: {
    archive: "アーカイブ", keywords: "キーワード", today: "過去の今日",
    searchPlaceholder: "タイトル・キーワード・日付で検索", categoryHint: "← 左右にスワイプしてカテゴリーを確認 →",
    ...
    guideTitle: "アーカイブ利用ガイド", guideSearchLabel: "検索", guideCalendarLabel: "カレンダー", guideFilterLabel: "フィルター",
    guideSearch: "日付(2024-01-01)、頭文字、キーワードで検索できます。（韓国語で検索してください）",
    guideCalendar: "点が表示された日付をクリックすると、その日の記録をまとめて表示します。",
    guideFilter: "カテゴリーと詳細分類から目的の動画を素早く探せます。上部のカテゴリーは横にスクロールできます。",
    guideContact: "エラーおよびその他のお問い合わせは @Penta_1031 までお願いいたします。",
    todayTitle: "{month}月{day}日の記録", yearsAgo: "{years}年前の今日"
  },
  en: {
    archive: "Archive", keywords: "Keyword", today: "On This Day",
    searchPlaceholder: "Search by title, keyword, or date", categoryHint: "← Swipe sideways to browse categories →",
    ...
    guideTitle: "Archive User Guide", guideSearchLabel: "Search", guideCalendarLabel: "Calendar", guideFilterLabel: "Filter",
    guideSearch: "Search by date (2024-01-01), Korean initials, or keywords. (Please search in Korean.)",
    guideCalendar: "Click a date marked with a dot to see all records from that day.",
    guideFilter: "Use categories and detailed filters to quickly find videos. The category menu scrolls horizontally.",
    guideContact: "For errors and other inquiries, please contact @Penta_1031.",
