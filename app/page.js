...
function PostypeView({ adminRequest = null }) {
  ...
  return <iframe ref={frameRef} src="postype/index.html?v=20260626-1" title="혚쾌 포타 검색기" allow="clipboard-read; clipboard-write" className="h-full w-full border-0 bg-black" />;
}
